<?php
/**
 * Página de Detalle de Producto - Helin
 */
$pageTitle = 'Implante Dental Straumann BLX - Helin';
...
<main class="container mx-auto px-4 py-8">
    ...
    <nav class="text-sm mb-6">
        ...
        <a href="catalogo.php" class="text-gray-500 hover:text-turquesa">Catálogo</a>
        <span class="text-gray-400 mx-2">></span>
        <a href="catalogo.php" class="text-gray-500 hover:text-turquesa">Implantología</a>
        <span class="text-gray-400 mx-2">></span>
    ...
    <section class="mb-12">
        <div class="mb-6">
            ...
            <a href="catalogo.php" class="text-turquesa font-semibold border-b border-turquesa pb-0.5">Ver todos los productos <i class="fas fa-arrow-right ml-1 text-[#00A3A0]"></i></a>
        </div>
