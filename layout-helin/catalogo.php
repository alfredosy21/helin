<?php
/**
 * Página de Catálogo - Helin
 */
$pageTitle = 'Catálogo de Productos - Helin';
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="hidden lg:block w-64 flex-shrink-0">
            <div class="space-y-6">
                ...
                <nav class="text-sm text-gray-500 mb-6">
                    <a href="index.php" class="hover:text-turquesa">Inicio</a>
                    <span class="text-gray-400 mx-1">></span>
                    <a href="catalogo.php" class="hover:text-turquesa">Categorías</a>
                    <span class="text-gray-400 mx-1">></span>
                ...
                <div class="mb-4">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Straumann</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Nobel Biocare</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Dentsply</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Kavo</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">NSK</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Nuevo</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Stock</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Premium</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-turquesa transition-colors">
                            <input type="checkbox" class="w-4 h-4 text-turquesa rounded border-gray-300">
                            <span class="ml-2 text-gray-600 text-sm">Básico</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                $productPrice = 45.00;
                $productOldPrice = 60.00;
                $productBadge = 'Oferta';
                $productBadgeColor = 'red';
                include 'components/product-card.php';
