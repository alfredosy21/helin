<?php
/**
 * Página de Carrito - Helin
 */
$pageTitle = 'Carrito de Compras - Helin';
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-[35%] xl:w-[30%]">
            <div class="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <!-- Botón de acción -->
                <a href="solicitud.php" class="block w-full bg-turquesa hover:bg-turquesa-dark text-white font-bold py-4 rounded-full uppercase transition-colors text-center">
                    Continuar Solicitud
                </a>
            </div>
        </div>
