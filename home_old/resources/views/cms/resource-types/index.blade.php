    ...
    <div class="relative z-10 p-6 space-y-6">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody id="resource-types-table-body" class="divide-y divide-slate-50 text-sm">
                        ...
                        <tr wire:key="resource-type-{{ $resourceType->id }}" data-id="{{ $resourceType->id }}" class="sortable-row hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center gap-2">
                                    <span class="w-2 h-2 rounded-full {{ $resourceType->is_active ? 'bg-primary' : 'bg-slate-300' }}"></span>
                                    <span class="text-xs font-medium {{ $resourceType->is_active ? 'text-slate-700' : 'text-slate-400' }}">
                                        {{ $resourceType->is_active ? __('cms.general.status_active') : __('cms.general.status_inactive') }}
                                    </span>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center text-[#c0c1c6]">
                                    ...
                                    <p class="text-xs font-medium">{{ __('cms.resource_types.no_types') }}</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-[#c0c1c6] mt-1">{{ __('cms.resource_types.subtitle') }}</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="p-6 space-y-6">
                    ...
                    {{-- Descripción --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.resource_types.description_label') }}</label>
