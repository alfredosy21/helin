    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Aditamentos',
                'banner_title' => 'Aditamentos Para Tus Procedimientos En Un Solo Lugar',
                'banner_description' => 'Encuentra aditamentos de alta calidad para complementar tus procedimientos clínicos.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 2,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Kits Quirúrgicos',
                'banner_title' => 'Kits Quirúrgicos Completos Para Cada Procedimiento',
                'banner_description' => 'Todo lo que necesitas en un solo kit para tus procedimientos quirúrgicos.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 3,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Biomateriales',
                'banner_title' => 'Biomateriales De Alta Calidad Para Tu Práctica Clínica',
                'banner_description' => 'Selección de biomateriales especializados para procedimientos de regeneración.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 4,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Suturas',
                'banner_title' => 'Suturas De Alta Calidad Para Procedimientos Odontológicos',
                'banner_description' => 'Amplia variedad de suturas especializadas para cirugías bucales y maxilofaciales.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 6,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Osteosíntesis',
                'banner_title' => 'Tornillos Y Fijaciones Para Cirugía Maxilofacial',
                'banner_description' => 'Tornillos de osteosíntesis de alta resistencia para procedimientos de fijación ósea.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 8,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Osteosíntesis',
                'banner_title' => 'Cajetines Y Accesorios Para Cirugía Maxilofacial',
                'banner_description' => 'Sistemas completos de cajetines para almacenamiento y uso de implantes quirúrgicos.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 9,
            ...
            [
                ...
                'banner_title' => 'Cuidados Especiales Para El Postoperatorio Quirúrgico',
                'banner_description' => 'Productos especializados para el cuidado y recuperación en el postoperatorio.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 10,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Cuidado Bucal',
                'banner_title' => 'Cuidados Diarios Para La Salud Bucal De Tu Paciente',
                'banner_description' => 'Soluciones para el cuidado diario y mantenimiento de la salud bucal.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 11,
            ...
            [
                ...
                'banner_description' => 'Tijeras y herramientas de corte de alta precisión para cirugía bucal.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 12,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Instrumentos',
                'banner_title' => 'Pinzas Y Herramientas Para Procedimientos Odontológicos',
                'banner_description' => 'Pinzas de alta calidad diseñadas para procedimientos odontológicos especializados.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 13,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Instrumentos',
                'banner_title' => 'Separadores Para Cirugía Bucal Y Maxilofacial',
                'banner_description' => 'Separadores de tejidos de alta precisión para una mejor visibilidad quirúrgica.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 14,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Instrumentos',
                'banner_title' => 'Cinceles Y Escoplos Para Cirugía Ósea',
                'banner_description' => 'Cinceles de acero quirúrgico de alta calidad para procedimientos de osteotomía.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 15,
            ...
            [
                ...
                'is_featured' => false,
                'banner_label' => 'Catálogo de Instrumentos',
                'banner_title' => 'Periostótomos Para Cirugía Bucal Especializada',
                'banner_description' => 'Periostótomos de precisión para el despegamiento y manejo de tejidos periósticos.',
                'banner_image' => null,
                'image' => null,
                'is_active' => true,
                'order' => 16,
