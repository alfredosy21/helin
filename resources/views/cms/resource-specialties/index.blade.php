    ...
    <div class="relative z-10 p-6 space-y-6">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <div>
                                            <div class="font-medium text-heading">{{ $resourceSpecialty->name }}</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-slate-400 mt-1">{{ __('cms.resource_specialties.subtitle') }}</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="p-6 space-y-6">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.resource_specialties.name_label') }} <span class="text-red-500">*</span></label>
                    ...
                    {{-- Descripción --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.resource_specialties.description_label') }}</label>
                    ...
                    {{-- Imagen --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Imagen</label>
                        <div class="relative">
                            @if($image)
