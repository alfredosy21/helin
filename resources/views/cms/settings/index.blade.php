        ...
        <div class="space-y-12">
            ...
            <div class="bg-white p-6 rounded-xl border border-slate-100">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button type="button" wire:click="addContactSubject" class="inline-flex items-center gap-2 rounded-lg bg-primary hover:bg-[#079d8b] text-white px-4 py-2 text-sm font-medium transition-colors border-none cursor-pointer">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
                        Agregar asunto
                    </button>
                </div>
