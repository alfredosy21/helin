<div class="min-h-screen bg-soft pb-12">
    ...
    <div class="p-3 sm:p-4 lg:p-6">
        <x-ui-section-header :module-id="\App\Models\Module::SETTINGS" :submodule-id="\App\Models\Submodule::GENERAL_SETTINGS" :subtitle="__('cms.settings.edit_subtitle')">
            <x-slot:action>
                <button type="button" wire:click="save" wire:loading.attr="disabled" wire:loading.class="opacity-75 cursor-not-allowed" class="min-w-[120px] flex items-center justify-center px-4 py-2 bg-primary hover:bg-[#079d8b] text-white text-[13px] font-medium rounded-lg transition-colors border-none cursor-pointer">
    ...
    <div class="px-3 sm:px-4 lg:px-6 space-y-4 sm:space-y-5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
            ...
            <x-ui-form-card title="{{ __('cms.settings.corporate_info') }}" description="Datos principales de la empresa" icon="building" class="lg:col-span-2">
