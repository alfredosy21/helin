<div class="min-h-screen pb-12 bg-[#f8fafc] relative">
    ...
    <div class="relative z-10 p-6 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
            <div>
                <x-cms-breadcrumb :module-id="\App\Models\Module::CATALOG" :submodule-id="\App\Models\Submodule::PRODUCT_PLATFORMS" />
                <p class="text-sm text-slate-500 mt-2.5">
                    {{ __('cms.product_platforms.title') }}
                </p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody id="product-platforms-table-body" class="divide-y divide-slate-50 text-sm">
                        ...
                        <tr wire:key="line-{{ $platform->id }}" data-id="{{ $platform->id }}" class="sortable-row hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center gap-2">
                                    <span class="w-2 h-2 rounded-full {{ $platform->is_active ? 'bg-primary' : 'bg-slate-300' }}"></span>
                                    <span class="text-xs font-medium {{ $platform->is_active ? 'text-slate-700' : 'text-slate-400' }}">
                                        {{ $platform->is_active ? __('cms.general.status_active') : __('cms.general.status_inactive') }}
                                    </span>
                                </div>
                            </td>
                        ...
                        <tr>
                          <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center text-[#c0c1c6]">
                                    ...
                                    <p class="text-xs font-medium">{{ __('cms.product_platforms.no_results') }}</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-[#c0c1c6] mt-1">{{ __('cms.product_platforms.subtitle') }}</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.product_platforms.name_label') }} <span class="text-red-500">*</span></label>
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.product_platforms.slug_label') }}</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.general.seo_keywords_label') }}</label>
