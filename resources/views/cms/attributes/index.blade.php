    ...
    <div class="relative z-10 p-6 space-y-6">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50 text-sm">
                        ...
                        <tr wire:key="attribute-{{ $attribute->id }}" class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="font-medium text-heading">{{ $attribute->name }}</div>
                                @if($attribute->unit)
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-slate-400 mt-1">{{ __('cms.attributes.subtitle') }}</p>
            </div>
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="p-6 space-y-6">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.name_label') }} <span class="text-red-500">*</span></label>
                    ...
                    {{-- Slug --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.slug_label') }}</label>
                    ...
                    {{-- Tipo de campo --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.type_label') }} <span class="text-red-500">*</span></label>
                    ...
                    {{-- Unidad --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.unit_label') }}</label>
                    ...
                    <div class="space-y-1.5" wire:key="options-block-{{ $type }}">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.options_label') }}</label>
                    ...
                    {{-- Descripción --}}
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('cms.attributes.description_label') }}</label>
