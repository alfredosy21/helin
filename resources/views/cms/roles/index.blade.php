    ...
    <div class="relative z-10 p-6 space-y-6">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden animate-in fade-in duration-200">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-slate-400 mt-1">{{ __('cms.roles.form_subtitle') }}</p>
            </div>

            <form wire:submit.prevent="save" class="w-full">
                <div class="p-6 space-y-5">
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-slate-400 uppercase tracking-wider block">{{ __('cms.roles.name_label') }} <span class="text-red-500">*</span></label>
