        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600">
        ...
        <div class="lg:col-span-2">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                            ...
                            <div class="space-y-2 mb-3">
                                @if($product->category)
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs font-medium text-primary-600">{{ $product->category->name }}</span>
                                    </div>
                                @endif
                                @if($product->brand)
                                    <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                <button wire:click="edit({{ $product->id }})"
                                        class="flex-1 text-sm bg-primary-50 text-primary-600 py-2 px-3 rounded-lg hover:bg-primary-100 transition-colors">
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <button wire:click="create" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">
                ...
                <form wire:submit="save" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input wire:model="slug" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="se-genera-automáticamente">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="currency" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <!-- Clinical Specs -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Especificaciones Clínicas</label>
                        <textarea wire:model="clinical_specs" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Especificaciones técnicas del producto..."></textarea>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input wire:model="meta_title" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Título para SEO">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Meta Descripción</label>
                                <textarea wire:model="meta_description" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Descripción para SEO"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Meta Keywords</label>
                                <input wire:model="meta_keywords" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="palabra1, palabra2, palabra3">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Sale Section -->
                    <div class="border-t border-gray-200 pt-6">
                        <h4 class="text-sm font-bold text-gray-700 mb-4">Promociones y Descuentos</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Precio de Oferta</label>
                                <input wire:model="sale_price" type="number" step="0.01" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="0.00">
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Fecha Inicio</label>
                                    <input wire:model="sale_start_date" type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Fecha Fin</label>
                                    <input wire:model="sale_end_date" type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model="published_at" type="datetime-local" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <label class="flex items-center">
                            <input wire:model="is_active" type="checkbox" class="rounded border-gray-300 text-primary-600 focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-700">Activo</span>
                        </label>
                        <label class="flex items-center">
                            <input wire:model="is_featured" type="checkbox" class="rounded border-gray-300 text-primary-600 focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-700">Destacado</span>
                        </label>
                        <label class="flex items-center">
                            <input wire:model="is_new" type="checkbox" class="rounded border-gray-300 text-primary-600 focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-700">Nuevo</span>
                        </label>
                        <label class="flex items-center">
                            <input wire:model="is_on_sale" type="checkbox" class="rounded border-gray-300 text-primary-600 focus:ring-blue-500">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" wire:loading.attr="disabled" class="px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50">
