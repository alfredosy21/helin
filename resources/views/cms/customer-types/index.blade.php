    ...
    <div class="relative z-10 p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody id="customer-types-table-body" class="divide-y divide-slate-100 text-[13px]">
                        ...
                        <tr wire:key="customer-type-{{ $type->id }}" data-id="{{ $type->id }}" class="sortable-row hover:bg-slate-50/70 transition-colors duration-150">
                            ...
                            <td class="px-4 py-2.5">
                                <span class="text-[13px] text-body">{{ $type->description ?? '—' }}</span>
                            </td>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-4 sm:p-6 border-b border-slate-50">
                ...
                <p class="text-[13px] text-body mt-1">{{ __('cms.customer_types.subtitle') }}</p>
            </div>
                ...
                <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p class="text-[13px] text-body italic mt-1">{{ __('cms.customer_types.slug_helper') }}</p>
                        </div>
                    </div>
