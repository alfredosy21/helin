    ...
    <div class="relative z-10 p-6 space-y-6">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-medium {{ $method->is_active ? 'text-slate-700' : 'text-slate-400' }}">
                                        {{ $method->is_active ? __('cms.general.status_active') : __('cms.general.status_inactive') }}
                                    </span>
                                </div>
                            </td>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl border border-slate-100 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-50">
                ...
                <p class="text-xs text-[#c0c1c6] mt-1">{{ __('cms.delivery_methods.subtitle') }}</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.delivery_methods.name_label') }} <span class="text-red-500">*</span></label>
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.delivery_methods.slug_label') }}</label>
                            ...
                            <p class="text-xs text-[#c0c1c6] italic mt-1">{{ __('cms.delivery_methods.slug_helper') }}</p>
                        </div>
                    </div>

                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-[#c0c1c6] uppercase tracking-wider">{{ __('cms.delivery_methods.description_label') }}</label>
