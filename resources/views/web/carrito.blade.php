    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-[65%] xl:w-[70%]">
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <!-- Producto 1 -->
                <div class="p-4 md:p-0 border-b border-helin-border">
                    <!-- Vista móvil -->
                    <div class="md:hidden flex gap-4">
                        <img src="https://via.placeholder.com/80x80/f8f9fa/6BC2C3?text=Implante" alt="Producto" class="w-20 h-20 object-contain rounded-lg flex-shrink-0">
                        <div class="flex-1">
                            <h3 class="font-semibold text-turquesa text-sm mb-1">Implante Dental Straumann BLX</h3>
                            <p class="text-helin-text text-xs mb-2">SKU: STL-BLX-408</p>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button class="text-helin-text hover:text-red-500 transition"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                    <!-- Vista desktop -->
                    <div class="hidden md:grid md:grid-cols-12 items-center">
                        <div class="col-span-5 px-6 py-5 flex items-center gap-4">
                            <img src="https://via.placeholder.com/80x80/f8f9fa/6BC2C3?text=Implante" alt="Producto" class="w-16 h-16 object-contain rounded-lg">
                            <div>
                                <h3 class="font-semibold text-turquesa text-sm">Implante Dental Straumann BLX</h3>
                                <p class="text-helin-text text-xs">SKU: STL-BLX-408</p>
                            </div>
                        </div>
                ...
                <div class="p-4 md:p-0 border-b border-helin-border">
                    <!-- Vista móvil -->
                    <div class="md:hidden flex gap-4">
                        <img src="https://via.placeholder.com/80x80/f8f9fa/6BC2C3?text=Biomaterial" alt="Producto" class="w-20 h-20 object-contain rounded-lg flex-shrink-0">
                        <div class="flex-1">
                            <h3 class="font-semibold text-turquesa text-sm mb-1">Biomaterial Óseo Bio-Oss</h3>
                            <p class="text-helin-text text-xs mb-2">SKU: GEO-BOSS-05</p>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-helin-text line-through text-xs">$149.00</span>
                                <span class="text-turquesa font-medium text-sm">$149.00</span>
                            </div>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-helin-text text-sm">$149.00</span>
                                <div class="flex items-center rounded-full bg-turquesa/10 overflow-hidden px-2.5" style="padding: 5px 10px;">
                                    <button class="w-8 h-8 bg-turquesa-dark hover:bg-turquesa text-white rounded-full flex items-center justify-center text-sm transition-colors" onclick="if(this.nextElementSibling.value > 1) this.nextElementSibling.value--">-</button>
                    ...
                    <div class="hidden md:grid md:grid-cols-12 items-center">
                        <div class="col-span-5 px-6 py-5 flex items-center gap-4">
                            <img src="https://via.placeholder.com/80x80/f8f9fa/6BC2C3?text=Biomaterial" alt="Producto" class="w-16 h-16 object-contain rounded-lg">
                            <div>
                                <h3 class="font-semibold text-turquesa text-sm">Biomaterial Óseo Bio-Oss</h3>
                                <p class="text-helin-text text-xs">SKU: GEO-BOSS-05</p>
                            </div>
                        </div>
                        <div class="col-span-2 px-4 py-5 text-center">
                            <div>
                                <span class="text-helin-text line-through text-xs block">$149.00</span>
        ...
        <div class="lg:w-[35%] xl:w-[30%]">
            <div class="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <div class="bg-helin-soft rounded-lg p-4 mb-6">
                    ...
                    <p class="text-sm text-helin-text mb-2">1 USD = 36.50 Bs.</p>
