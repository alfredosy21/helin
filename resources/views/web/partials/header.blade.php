    ...
    <div class="bg-white border-t border-gray-200 relative">
        ...
        <div class="hidden lg:block container mx-auto px-4 py-3">
            <div class="flex items-center justify-between gap-4">
                <nav class="flex items-center gap-4 xl:gap-6 text-sm">
                    ...
                    <!-- Inicio -->
                    <a href="{{ route('web.home') }}" class="text-gray-800 hover:text-turquesa font-bold whitespace-nowrap ml-16">Inicio</a>
                    <!-- Categorías -->
        ...
        <div class="lg:hidden border-t border-gray-100">
            <div class="flex overflow-x-auto scrollbar-hide py-2 px-4 gap-4 text-sm whitespace-nowrap">
                <a href="{{ route('web.catalogo') }}" class="text-gray-800 hover:text-turquesa font-bold flex-shrink-0">Productos</a>
                <a href="{{ route('web.home') }}" class="text-gray-800 hover:text-turquesa font-bold flex-shrink-0">Inicio</a>
