...
<div id="mobile-nav" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute left-0 top-0 h-full w-[280px] sm:w-80 bg-white shadow-xl transform -translate-x-full transition-transform duration-300" id="mobile-nav-panel">
        ...
        <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100%-70px)]">
            <a href="{{ route('web.home') }}" class="flex items-center gap-3 py-3 px-4 text-gray-800 font-semibold hover:bg-gray-50 rounded-lg">
                <i class="fas fa-home text-turquesa"></i> Inicio
            </a>
            <a href="{{ route('web.catalogo') }}" class="flex items-center gap-3 py-3 px-4 text-gray-800 font-semibold hover:bg-gray-50 rounded-lg">
            ...
            <a href="{{ route('web.solicitud') }}" class="flex items-center gap-3 py-3 px-4 text-gray-700 hover:bg-gray-50 rounded-lg">
