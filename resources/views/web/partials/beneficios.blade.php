    ...
    <div class="container mx-auto px-4">
        <div class="flex md:grid md:grid-cols-5 gap-4 overflow-x-auto md:overflow-visible pb-2 md:pb-0 scrollbar-hide">
            <div class="flex items-center gap-3 p-4 min-w-[200px] md:min-w-0">
                ...
                <div>
                    <h4 class="font-semibold text-helin-heading text-sm">Envíos rápidos y seguros</h4>
                    <p class="text-helin-text text-xs">A toda Venezuela</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-4 min-w-[200px] md:min-w-0">
                <div class="w-12 h-12 bg-turquesa/20 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <h4 class="font-semibold text-helin-heading text-sm">Garantía Helin</h4>
                    <p class="text-helin-text text-xs">Calidad y respaldo en cada producto</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-4 min-w-[200px] md:min-w-0">
                <div class="w-12 h-12 bg-turquesa/20 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <h4 class="font-semibold text-helin-heading text-sm">Asesoría especializada</h4>
                    <p class="text-helin-text text-xs">Soporte técnico y comercial</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-4 min-w-[200px] md:min-w-0">
                <div class="w-12 h-12 bg-turquesa/20 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <h4 class="font-semibold text-helin-heading text-sm">Stock disponible</h4>
                    <p class="text-helin-text text-xs">Productos de las mejores marcas</p>
                </div>
            </div>
            <div class="flex items-center gap-3 p-4 min-w-[200px] md:min-w-0">
                <div class="w-12 h-12 bg-turquesa/20 rounded-xl flex items-center justify-center flex-shrink-0">
