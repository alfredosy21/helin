@php
    ...
    $variantClasses = [
        'primary' => 'bg-primary-500 text-white hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed',
        'secondary' => 'bg-white border border-line text-heading hover:bg-soft focus:ring-primary/20 disabled:opacity-50 disabled:cursor-not-allowed',
    ...
    $baseClasses = 'inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/20';
